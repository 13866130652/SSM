    ...
    <section class="publicMian ">
        <div class="left">
            ...
            <nav>
              ...
              <!-- 页面已经处理 --><li  id="active"><a href="user/userList">用户管理</a></li>
        ...
        <div class="right">
            ...
            <div class="search">
            	<form action="user/userList" method="get" calss="search_form">
                	<span>用户名：</span>
            ...
            <table class="providerTable" cellpadding="0" cellspacing="0">
               ...
               <c:forEach items="${USER_LIST}" var="list" varStatus="i">
              	   	<tr>
                    <td>${list.userCode}</td>
                    <td>${list.userName}</td>
